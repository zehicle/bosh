  ...
  describe '#run' do
    ...
    describe 'configure cloud' do
      it 'configures cloud with the director uuid' do
        ...
        expect(Bosh::OpenCrowbar::Config.uuid).to eq('abc')
      end
    end
    ...
    context 'when error is a subclass of CpiError (cpi failure)' do
      class ErrorClass1 < Bosh::OpenCrowbar::CpiError; end
    ...
    context 'when error is a subclass of CloudError (infrastructure failure)' do
      class ErrorClass2 < Bosh::OpenCrowbar::CloudError; end
    ...
    context 'when error is a subclass of RetriableCloudError' do
      class ErrorClass3 < Bosh::OpenCrowbar::RetriableCloudError; end
    ...
    context 'when error is not a subclass of known Bosh::OpenCrowbar errors' do
    ...
    context 'when error class name contains sequential uppercase letters' do
      class ERRClass5 < Bosh::OpenCrowbar::CpiError; end
